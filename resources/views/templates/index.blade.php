...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="d-flex align-items-center justify-content-between">
      <a href="/">
        <img src="assets/img/bcasLogo.jpeg" alt="" width="200">
      </a>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      {{-- &copy; Copyright <strong><span><img src="assets/img/bcasLogo.jpeg" alt="" width="100"></span></strong>. All Rights Reserved --}}
    </div>
  </footer><!-- End Footer -->
